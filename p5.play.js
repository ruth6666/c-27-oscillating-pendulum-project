...
/**
   ...
   * @param {Number} width Width of the placebase rectangle and of the
   *                       collider until an image or new collider are set
   * @param {Number} height Height of the placebase rectangle and of the
   *                       collider until an image or new collider are set
...
function Sprite(pInst, _x, _y, _w, _h) {
  ...
  */
   ...
   * placebase rectangle or the bounding box of the image.
   *
